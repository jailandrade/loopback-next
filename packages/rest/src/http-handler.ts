...
export class HttpHandler {
   ...
   */
  protected _apiComponents: ComponentsObject = {};
  ...
  registerApiComponents(defs: ComponentsObject) {
    for (const p in defs) {
      ...
      this._apiComponents[p] = {...this._apiComponents[p], ...defs[p]};
    }
  }

  getApiComponents() {
    return this._apiComponents;
  }
   ...
   */
  getApiDefinitions() {
    return this._apiComponents?.schemas;
  }
